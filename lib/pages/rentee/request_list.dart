...
class RenteeSupportRequestListPage extends StatefulWidget {
  createState() => RenteeSupportRequestListPageState();
}

class RenteeSupportRequestListPageState extends State<RenteeSupportRequestListPage> {
  ...
  Future getList() async {
    ...
    allorders.removeWhere((element){return element.rentee.id != UserProvider.currentUser.id;});
